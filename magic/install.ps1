...
Function Detect-Installed-Compilers-Include-Paths {
    ...
    Find-Include-Folder-With-Path "C:\Program Files\LLVM\lib\clang\"
    Find-Include-Folder-With-Path "C:\Program Files (x86)\LLVM\lib\clang\"
...
Function Add-Exotic-Libraries {
    ...
    $Global:EXOTIC_LIBRARIES.Add("liblogax")
}
